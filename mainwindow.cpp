...
{
    QString licenceAndInfoText = QString::fromWCharArray(L"QGreatstAtzenta. Version 1.3.5.1. A program for organizing your contacts.<BR><BR>Copyright (C) 2011-2024 Stavros Filippidis<BR>author's email: <A HREF='mailto:stavros@filippidis.name'>stavros@filippidis.name</A><BR>author's website: <A HREF='https://www.filippidis.name/'>https://www.filippidis.name/</A><BR>GitHub repo: <A HREF='https://github.com/SFilippidis/QGreatstAtzenta'>https://github.com/SFilippidis/QGreatstAtzenta</A><BR><BR>QGreatstAtzenta is free software: you can redistribute it and/or modify<BR>it under the terms of the GNU General Public License as published by<BR>the Free Software Foundation, either version 3 of the License, or<BR>(at your option) any later version.<BR><BR>QGreatstAtzenta is distributed in the hope that it will be useful,<BR>but WITHOUT ANY WARRANTY; without even the implied warranty of<BR>MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the<BR>GNU General Public License for more details.<BR><BR>You should have received a copy of the GNU General Public License<BR>along with QGreatstAtzenta.  If not, see <A HREF='http://www.gnu.org/licenses/'>http://www.gnu.org/licenses/</A>.<BR>");
